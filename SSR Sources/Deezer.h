...
// A document.
@interface DeezerDocument : SBObject
...
// A window.
@interface DeezerWindow : SBObject
...
@property (readonly) double playerPosition;  // player position in the currently playing track in seconds
...
// A Deezer track.
@interface DeezerTrack : SBObject
